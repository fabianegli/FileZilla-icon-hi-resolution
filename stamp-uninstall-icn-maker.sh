...
### low resolution
inkscape FileZilla_stamp_small.svg --export-png=StampUninstallFileZilla.iconset/icon_16x16.png --export-width=16 --export-height=16
inkscape FileZilla_stamp_small.svg --export-png=StampUninstallFileZilla.iconset/icon_32x32.png --export-width=32 --export-height=32
...
### high resolution
inkscape FileZilla_stamp_small.svg --export-png=StampUninstallFileZilla.iconset/icon_16x16@2x.png --export-width=32 --export-height=32
inkscape FileZilla_stamp_small.svg --export-png=StampUninstallFileZilla.iconset/icon_32x32@2x.png --export-width=64 --export-height=64
